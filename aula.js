...
// ==============================
// Cerrar sesión — manejado por auth-guard.js (Firebase signOut)
// ==============================
...
// ==============================
// Cargar talleres del aula desde Firestore (gestionados por el admin).
// Si hay talleres publicados, reemplazan a los hardcodeados. Si Firestore
// falla o está vacío, se mantienen los locales como respaldo.
// ==============================
(async () => {
  try {
    ...
    const q = fs.query(fs.collection(db, "talleres_aula"), fs.orderBy("createdAt", "asc"));
    ...
    snap.forEach((d) => {
      ...
      remotos.push({
        ...
        lesson: x.lesson || "",
        image: x.image || "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=600&q=80&auto=format&fit=crop",
    ...
    console.warn("[aula] No se pudieron cargar talleres del aula desde Firestore:", err);
  }
})();
